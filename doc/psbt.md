# PSBT Howto for Groestlcoin Core

Since Groestlcoin Core 2.17.2, an RPC interface exists for Partially Signed Groestlcoin
...
PSBT is an interchange format for Groestlcoin transactions that are not fully signed
...
#### Multisig with multiple Groestlcoin Core instances
