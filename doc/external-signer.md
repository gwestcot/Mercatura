...
The following example is based on the [HWI](https://github.com/groestlcoin-core/HWI) tool. Version 2.0 or newer is required. Although this tool is hosted under the Groestlcoin Core GitHub organization and maintained by Groestlcoin Core developers, it should be used with caution. It is considered experimental and has far less review than Groestlcoin Core itself. Be particularly careful when running tools such as these on a computer with private keys on it.
...
$ groestlcoin-cli -rpcwallet=<wallet> walletdisplayaddress <address>
```
