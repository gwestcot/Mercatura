...
RPCHelpMan getreceivedbyaddress()
{
    return RPCHelpMan{
        ...
        "Returns the total amount received by the given address in transactions with at least minconf confirmations.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Mercatura address for transactions."},
...
RPCHelpMan lockunspent()
{
    return RPCHelpMan{
        ...
        "Updates list of temporarily unspendable outputs.\n"
                ...
                "A locked transaction output will not be chosen by automatic coin selection, when spending Mercatura.\n"
    ...
    return RPCHelpMan{
        ...
        "Returns array of unspent transaction outputs\n"
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, RPCArg::Default{UniValue::VARR}, "The Mercatura addresses to filter",
                        {
                            {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "Mercatura address"},
                        },
                    },
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::NUM, "vout", "the vout value"},
                            {RPCResult::Type::STR, "address", /*optional=*/true, "the Mercatura address"},
