        ...
        "If a label name is provided, this will return only incoming transactions paying to addresses with the specified label.\n"
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        ...
                        {
                            {RPCResult::Type::STR, "address",  /*optional=*/true, "The groestlcoin address of the transaction (not returned if the output does not have an address, e.g. OP_RETURN null data)."},
                            {RPCResult::Type::STR, "category", "The transaction category.\n"
                                "\"send\"                  Transactions sent.\n"
                                "\"receive\"               Non-coinbase transactions received.\n"
                                "\"generate\"              Coinbase transactions received with more than 120 confirmations.\n"
                                "\"immature\"              Coinbase transactions received with 120 or fewer confirmations.\n"
...
RPCHelpMan listsinceblock()
{
    return RPCHelpMan{
        ...
        "Get all transactions in blocks since block [blockhash], or all transactions if omitted.\n"
            ...
            + HelpExampleCli("listsinceblock", "\"00000000000012e815b167b1a2979ecec7da4bd09719b5130f70dfa4baeaf444\" 6")
            + HelpExampleRpc("listsinceblock", "\"00000000000012e815b167b1a2979ecec7da4bd09719b5130f70dfa4baeaf444\", 6")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    const std::shared_ptr<const CWallet> pwallet = GetWalletForJSONRPCRequest(request);
                ...
                RPCResult{
                    ...
                    TransactionDescriptionString()),
                    {
                        {RPCResult::Type::ARR, "details", "",
                        {
                            {RPCResult::Type::OBJ, "", "",
                            {
                                {RPCResult::Type::STR, "address", /*optional=*/true, "The groestlcoin address involved in the transaction."},
                                {RPCResult::Type::STR, "category", "The transaction category.\n"
                                    "\"send\"                  Transactions sent.\n"
                                    "\"receive\"               Non-coinbase transactions received.\n"
                                    "\"generate\"              Coinbase transactions received with more than 120 confirmations.\n"
