...
The input UTXO set can be generated by Groestlcoin Core with the `dumptxoutset` RPC:
$ groestlcoin-cli dumptxoutset ~/utxos.dat latest
...
UTXO_DUMP_VERSION = 2
NET_MAGIC_BYTES = {
    b"\xf9\xbe\xb4\xd4": "Mainnet",
    b"\x6f\x89\x2b\x8f": "Signet",
