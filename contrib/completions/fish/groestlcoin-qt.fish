...
complete --command groestlcoin-qt --no-files

# Extract options
function __fish_groestlcoinqt_get_options
...
complete \
    --command groestlcoin-qt \
    --arguments "(__fish_groestlcoinqt_get_options --nofiles)"
