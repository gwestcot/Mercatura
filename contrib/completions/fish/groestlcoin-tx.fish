...
# Extract options
function __fish_groestlcoin_tx_get_options
...
# Extract commands
function __fish_groestlcoin_tx_get_commands
...
complete \
    ...
    --condition "not __fish_groestlcoin_seen_cmd (__fish_groestlcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_groestlcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command groestlcoin-tx \
    --arguments "(__fish_groestlcoin_tx_get_commands)" \
    --no-files
