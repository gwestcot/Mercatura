...
complete --command groestlcoind --no-files

# Extract options
function __fish_groestlcoind_get_options
...
complete \
    --command groestlcoind \
    --arguments "(__fish_groestlcoind_get_options --nofiles)"
