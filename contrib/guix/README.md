# Bootstrappable Groestlcoin Core Builds
...
To build Groestlcoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Groestlcoin Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/groestlcoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/groestlcoin-core/guix.sigs).
